...
[[ -f ".octopus_env" ]] && source .octopus_env
...
PROJECT_SLUG="${PROJECT_SLUG:-PLUGIN_PROJECT_SLUG}"
VERSION="${VERSION:-PLUGIN_VERSION}"
SERVER_URL="${SERVER_URL:-PLUGIN_SERVER_URL}"
API_KEY="${API_KEY:-PLUGIN_API_KEY}"
STEP_NAME="${STEP_NAME:-PLUGIN_STEP_NAME}"
ENVIRONMENT_NAME="${ENVIRONMENT_NAME:-PLUGIN_ENVIRONMENT_NAME}"
